Rails.application.routes.draw do
  ...
  post("/insert_departments", { :controller => "departments", :action => "create" })

  get("/departments", { :controller => "departments", :action => "index" })
  
  post("/modify_departments/:path_id", { :controller => "departments", :action => "update" })

  get("/delete_departments/:path_id", { :controller => "departments", :action => "destroy" })
  ...
  post("/insert_students", { :controller => "students", :action => "create" })

  get("/students", { :controller => "students", :action => "index" })
  
  post("/modify_students/:path_id", { :controller => "students", :action => "update" })

  get("/delete_students/:path_id", { :controller => "students", :action => "destroy" })
